...
searchQuery = '#sciencepolicy OR #STIP2021 OR #scipol OR #scienceadvice OR #sciencediplomacy OR \
		#scidip OR #techdiplomacy OR #scicomm OR #aipolicy OR #netneutrality OR #Coviddiplomacy \
		OR #vaccinediplomacy OR  OR #techplomacy OR #ScienceTechnologyStudies OR #researchandinnovation \
		OR #scienceethics OR #datagovernance OR #biosecurity OR #innovationstudies OR #industryresearch \
		OR #scienceandinnovation OR #emergingtechnologies OR #researchpolicy OR #spacepolicy OR #UNFCCC -filter:retweets AND -filter:replies'
